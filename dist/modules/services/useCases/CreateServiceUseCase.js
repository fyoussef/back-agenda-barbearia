...
var CreateServiceUseCase = /** @class */ (function () {
    ...
    CreateServiceUseCase.prototype.execute = function (_a) {
        var name = _a.name, duration = _a.duration, price = _a.price;
        return __awaiter(this, void 0, void 0, function () {
            var serviceExist;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, prismaClient_1.prisma.service.findFirst({
                            where: {
                                name: {
                                    equals: name,
                                    mode: 'insensitive'

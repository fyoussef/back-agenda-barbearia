...
var CreateClientController = /** @class */ (function () {
    ...
    CreateClientController.prototype.handle = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, phone, email, createClient, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, name = _a.name, phone = _a.phone, email = _a.email;
                        createClient = new CreateClientUseCase_1.CreateClientUseCase();
                        return [4 /*yield*/, createClient.execute({ name: name, phone: phone, email: email })];
                    case 1:
                        result = _b.sent();
